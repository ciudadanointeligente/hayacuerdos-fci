...
function drawpositions(index, row, sheet_page) {
  ...
  if( row.class === 'noacuerdo' ) {
    ...
    posture2 = '<div class="col-md-2 noacuerdo postura2"><p><span class="title-compare strong hidden-md hidden-lg">'+opositor_name+'</span><span class="hidden-md hidden-lg">: </span>'+row.postura2+view_more_b+posture2_twitter+'</p></div>';
  ...
  if( row.class === 'acuerdoparcial' ) {
    ...
    posture2 = '<div class="col-md-2 acuerdoparcial postura2"><p><span class="title-compare strong hidden-md hidden-lg">'+opositor_name+'</span><span class="hidden-md hidden-lg">: </span>'+row.postura2+view_more_b+posture2_twitter+'</p></div>';
  ...
  if( row.class === 'acuerdototal' ) {
    ...
    posture2 = '<div class="col-md-2 acuerdototal postura2"><p><span class="title-compare strong hidden-md hidden-lg">'+opositor_name+'</span><span class="hidden-md hidden-lg">: </span>'+row.postura2+view_more_b+posture2_twitter+'</p></div>';
